export default {
  global: {
    componenteFormativo: 'Escenario avanzado de interoperabilidad',
    descripcionCurso:
      'A partir de este módulo el aprendiz estará en la capacidad de diseñar un escenario avanzado de interoperabilidad mediante el uso del ecosistema X-Road lo cual le exige la definición del esquema de interoperabilidad, la adaptación y configuración de componentes X-Road, la adaptación y configuración de componentes externos, la exposición de servicios, el consumo de servicios y en general la integración de servicios.',
